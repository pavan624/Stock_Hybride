...
public class ExcelFileUtil {
	...
	public  ExcelFileUtil() throws Exception{
		FileInputStream fi=new FileInputStream ("D:\\ypavanprograms\\Stock_Accounting_MVN\\Testinput\\InputSheet.xlsx");
			...
			
	{
		...
		FileOutputStream fos=new FileOutputStream("D:\\ypavanprograms\\Stock_Accounting_MVN\\Testinput\\InputSheet.xlsx");
		wb.write(fos);
		fos.close();
